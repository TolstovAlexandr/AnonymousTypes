...
namespace AnonymousTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BuildAnnType("BMW", "Black", 90);
            Console.WriteLine("////////////////////////////////////////////////");
            EqualityTest();
        }
        static void BuildAnnType(string make, string color, int currSp)
        {
            // Build anon type using incoming args.
            var car = new { Make = make, Color = color, Speed = currSp };

            // Note you can now use this type to get the property data!
            Console.WriteLine("You hane a {0} {1} going {2} MPH", car.Color, car.Make, car.Speed);
